...
public readonly partial record struct Weight<T> : IVector0<Weight<T>, T>, IPhysicalQuantity<Weight<T>, T>
	where T : struct, INumber<T>
{
	...
	public static Weight<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<Weight<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<Weight<T>, T>(this, other);

	/// <summary>Adds two <see cref="Weight{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Weight<T> operator +(Weight<T> left, Weight<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="Weight{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Weight<T> operator -(Weight<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="Weight{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Weight<T> operator *(Weight<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="Weight{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Weight<T> operator *(T left, Weight<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="Weight{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Weight<T> operator /(Weight<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="Weight{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(Weight<T> left, Weight<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(Weight<T> left, Weight<T> right) => left.Quantity < right.Quantity;
	...
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Weight<T> operator -(Weight<T> left, Weight<T> right) => Create(T.Abs(left.Quantity - right.Quantity));
}
