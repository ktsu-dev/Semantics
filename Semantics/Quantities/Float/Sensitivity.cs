...
public sealed record Sensitivity
{
	...
	public static new Sensitivity FromDbSplPerWatt(float dbSplPerWatt) => new() { Value = Generic.Sensitivity<float>.FromDbSplPerWatt(dbSplPerWatt) };
	...
	/// <returns>A new Sensitivity instance.</returns>
	public static new Sensitivity FromDbSplPerVolt(float dbSplPerVolt) => new() { Value = Generic.Sensitivity<float>.FromDbSplPerVolt(dbSplPerVolt) };
	...
	/// <returns>A new Sensitivity instance.</returns>
	public static new Sensitivity FromMvPerPa(float mvPerPa) => new() { Value = Generic.Sensitivity<float>.FromMvPerPa(mvPerPa) };
