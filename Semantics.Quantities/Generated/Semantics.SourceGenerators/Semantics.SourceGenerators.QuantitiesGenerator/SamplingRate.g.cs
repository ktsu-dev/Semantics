...
public readonly partial record struct SamplingRate<T> : IVector0<SamplingRate<T>, T>, IPhysicalQuantity<SamplingRate<T>, T>
	where T : struct, INumber<T>
{
	...
	public static SamplingRate<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<SamplingRate<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<SamplingRate<T>, T>(this, other);

	/// <summary>Adds two <see cref="SamplingRate{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SamplingRate<T> operator +(SamplingRate<T> left, SamplingRate<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="SamplingRate{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SamplingRate<T> operator -(SamplingRate<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="SamplingRate{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SamplingRate<T> operator *(SamplingRate<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="SamplingRate{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SamplingRate<T> operator *(T left, SamplingRate<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="SamplingRate{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SamplingRate<T> operator /(SamplingRate<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="SamplingRate{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(SamplingRate<T> left, SamplingRate<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(SamplingRate<T> left, SamplingRate<T> right) => left.Quantity < right.Quantity;
	...
	/// <returns>A new SamplingRate instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SamplingRate<T> FromKilohertz(T value) => Create(Vector0Guards.EnsureNonNegative((value * MetricMagnitudes.Values<T>.Kilo), nameof(value)));
	...
	/// <returns>A new SamplingRate instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SamplingRate<T> FromMegahertz(T value) => Create(Vector0Guards.EnsureNonNegative((value * MetricMagnitudes.Values<T>.Mega), nameof(value)));
