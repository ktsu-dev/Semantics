...
public sealed record Momentum
{
	...
	public static new Momentum FromKilogramMetersPerSecond(float kilogramMetersPerSecond) => new() { Value = Generic.Momentum<float>.FromKilogramMetersPerSecond(kilogramMetersPerSecond) };
