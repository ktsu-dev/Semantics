...
public readonly partial record struct GaugePressure<T> : IVector0<GaugePressure<T>, T>, IPhysicalQuantity<GaugePressure<T>, T>
	where T : struct, INumber<T>
{
	...
	public static GaugePressure<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<GaugePressure<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<GaugePressure<T>, T>(this, other);

	/// <summary>Adds two <see cref="GaugePressure{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static GaugePressure<T> operator +(GaugePressure<T> left, GaugePressure<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="GaugePressure{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static GaugePressure<T> operator -(GaugePressure<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="GaugePressure{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static GaugePressure<T> operator *(GaugePressure<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="GaugePressure{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static GaugePressure<T> operator *(T left, GaugePressure<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="GaugePressure{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static GaugePressure<T> operator /(GaugePressure<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="GaugePressure{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(GaugePressure<T> left, GaugePressure<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(GaugePressure<T> left, GaugePressure<T> right) => left.Quantity < right.Quantity;
	...
	/// <returns>A new GaugePressure instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static GaugePressure<T> FromKilopascal(T value) => Create(Vector0Guards.EnsureNonNegative((value * MetricMagnitudes.Values<T>.Kilo), nameof(value)));
	...
	/// <returns>A new GaugePressure instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static GaugePressure<T> FromBar(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.BarToPascals), nameof(value)));
	...
	/// <returns>A new GaugePressure instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static GaugePressure<T> FromAtmosphere(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.AtmosphereToPascals), nameof(value)));
	...
	/// <returns>A new GaugePressure instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static GaugePressure<T> FromPsi(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.PsiToPascals), nameof(value)));
	...
	/// <returns>A new GaugePressure instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static GaugePressure<T> FromTorr(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.TorrToPascals), nameof(value)));
	...
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static GaugePressure<T> operator -(GaugePressure<T> left, GaugePressure<T> right) => Create(T.Abs(left.Quantity - right.Quantity));
}
