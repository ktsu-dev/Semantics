...
public sealed record Acceleration2D : Generic.Acceleration2D<float>
{
	...
	public static new Acceleration2D FromMetersPerSecondSquared(float x, float y) => Create(x, y);
	...
	/// <returns>A new Acceleration2D instance.</returns>
	public static new Acceleration2D FromMetersPerSecondSquared(Vector2 metersPerSecondSquared) => Create(new Vector2f(metersPerSecondSquared));
