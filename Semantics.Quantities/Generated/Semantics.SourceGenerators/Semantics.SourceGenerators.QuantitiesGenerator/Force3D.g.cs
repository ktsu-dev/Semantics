	...
	where T : struct, INumber<T>
{
	...
	/// <summary>Creates a <see cref="Force3D{T}"/> from components in Newton.</summary>
	...
	/// <returns>A new <see cref="Force3D{T}"/> storing the SI-base equivalent.</returns>
	public static Force3D<T> FromNewton(T x, T y, T z) => new() { X = x, Y = y, Z = z };

	/// <summary>Creates a <see cref="Force3D{T}"/> from components in Kilonewton.</summary>
	...
	/// <returns>A new <see cref="Force3D{T}"/> storing the SI-base equivalent.</returns>
	public static Force3D<T> FromKilonewton(T x, T y, T z) => new() { X = (x * MetricMagnitudes.Values<T>.Kilo), Y = (y * MetricMagnitudes.Values<T>.Kilo), Z = (z * MetricMagnitudes.Values<T>.Kilo) };

	/// <summary>Creates a <see cref="Force3D{T}"/> from components in Dyne.</summary>
	...
	/// <returns>A new <see cref="Force3D{T}"/> storing the SI-base equivalent.</returns>
	public static Force3D<T> FromDyne(T x, T y, T z) => new() { X = (x * Units.ConversionConstants.Values<T>.DyneToNewtons), Y = (y * Units.ConversionConstants.Values<T>.DyneToNewtons), Z = (z * Units.ConversionConstants.Values<T>.DyneToNewtons) };

	/// <summary>Creates a <see cref="Force3D{T}"/> from components in PoundForce.</summary>
	...
	/// <returns>A new <see cref="Force3D{T}"/> storing the SI-base equivalent.</returns>
	public static Force3D<T> FromPoundForce(T x, T y, T z) => new() { X = (x * Units.ConversionConstants.Values<T>.PoundForceToNewtons), Y = (y * Units.ConversionConstants.Values<T>.PoundForceToNewtons), Z = (z * Units.ConversionConstants.Values<T>.PoundForceToNewtons) };

	/// <summary>Converts this vector's SI-base components to <paramref name="unit"/>.</summary>
	/// <remarks>Returns bare components rather than a <see cref="Force3D{T}"/>, because a vector that is not in base units cannot be one.</remarks>
