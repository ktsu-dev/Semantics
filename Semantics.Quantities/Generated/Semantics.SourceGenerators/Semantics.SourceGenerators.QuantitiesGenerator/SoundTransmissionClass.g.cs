...
public readonly partial record struct SoundTransmissionClass<T> : IVector0<SoundTransmissionClass<T>, T>, IPhysicalQuantity<SoundTransmissionClass<T>, T>
	where T : struct, INumber<T>
{
	...
	public static SoundTransmissionClass<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<SoundTransmissionClass<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<SoundTransmissionClass<T>, T>(this, other);

	/// <summary>Adds two <see cref="SoundTransmissionClass{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundTransmissionClass<T> operator +(SoundTransmissionClass<T> left, SoundTransmissionClass<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="SoundTransmissionClass{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundTransmissionClass<T> operator -(SoundTransmissionClass<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="SoundTransmissionClass{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundTransmissionClass<T> operator *(SoundTransmissionClass<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="SoundTransmissionClass{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundTransmissionClass<T> operator *(T left, SoundTransmissionClass<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="SoundTransmissionClass{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundTransmissionClass<T> operator /(SoundTransmissionClass<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="SoundTransmissionClass{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(SoundTransmissionClass<T> left, SoundTransmissionClass<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(SoundTransmissionClass<T> left, SoundTransmissionClass<T> right) => left.Quantity < right.Quantity;
	...
	/// <returns>A new SoundTransmissionClass instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SoundTransmissionClass<T> FromDegree(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.DegreeToRadians), nameof(value)));
	...
	/// <returns>A new SoundTransmissionClass instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SoundTransmissionClass<T> FromGradian(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.GradianToRadians), nameof(value)));
	...
	/// <returns>A new SoundTransmissionClass instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SoundTransmissionClass<T> FromRevolution(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.RevolutionToRadians), nameof(value)));
	...
	/// <returns>A new SoundTransmissionClass instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SoundTransmissionClass<T> FromMilliradian(T value) => Create(Vector0Guards.EnsureNonNegative((value * MetricMagnitudes.Values<T>.Milli), nameof(value)));
	...
	/// <returns>A new SoundTransmissionClass instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SoundTransmissionClass<T> FromPercent(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.PercentToRatio), nameof(value)));
	...
	/// <returns>A new SoundTransmissionClass instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SoundTransmissionClass<T> FromPartPerMillion(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.PartPerMillionToRatio), nameof(value)));
	...
	/// <returns>A new SoundTransmissionClass instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SoundTransmissionClass<T> FromPartPerBillion(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.PartPerBillionToRatio), nameof(value)));
	...
	/// <returns>A new SoundTransmissionClass instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SoundTransmissionClass<T> FromPercentByWeight(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.PercentByWeightToRatio), nameof(value)));
