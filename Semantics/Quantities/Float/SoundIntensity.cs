...
public sealed record SoundIntensity
{
	...
	public static new SoundIntensity FromWattsPerSquareMeter(float wattsPerSquareMeter) => new() { Value = Generic.SoundIntensity<float>.FromWattsPerSquareMeter(wattsPerSquareMeter) };
	...
	/// <returns>A new SoundIntensity instance.</returns>
	public static new SoundIntensity FromMicrowattsPerSquareCentimeter(float microwattsPerSquareCentimeter) => new() { Value = Generic.SoundIntensity<float>.FromMicrowattsPerSquareCentimeter(microwattsPerSquareCentimeter) };
