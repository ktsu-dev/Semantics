...
public readonly partial record struct Conductance<T> : IVector0<Conductance<T>, T>, IPhysicalQuantity<Conductance<T>, T>
	where T : struct, INumber<T>
{
	...
	public static Conductance<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<Conductance<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<Conductance<T>, T>(this, other);

	/// <summary>Adds two <see cref="Conductance{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Conductance<T> operator +(Conductance<T> left, Conductance<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="Conductance{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Conductance<T> operator -(Conductance<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="Conductance{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Conductance<T> operator *(Conductance<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="Conductance{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Conductance<T> operator *(T left, Conductance<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="Conductance{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Conductance<T> operator /(Conductance<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="Conductance{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(Conductance<T> left, Conductance<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(Conductance<T> left, Conductance<T> right) => left.Quantity < right.Quantity;
	...
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Conductance<T> operator -(Conductance<T> left, Conductance<T> right) => Create(T.Abs(left.Quantity - right.Quantity));

	/// <summary>
	/// Multiplies Conductance by VoltageMagnitude to produce CurrentMagnitude.
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static CurrentMagnitude<T> operator *(Conductance<T> left, VoltageMagnitude<T> right) => CurrentMagnitude<T>.Create(left.Quantity * right.Quantity);
}
