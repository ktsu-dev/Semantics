	...
	where T : struct, INumber<T>
{
	...
	/// <returns>A new <see cref="CatalyticActivity{T}"/> instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static CatalyticActivity<T> FromEnzymeUnit(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.EnzymeUnitToKatals), nameof(value)));
