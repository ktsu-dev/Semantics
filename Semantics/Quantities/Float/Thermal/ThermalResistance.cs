...
public sealed record ThermalResistance : Generic.ThermalResistance<float>
{
	...
	public static new ThermalResistance FromKelvinPerWatt(float kelvinPerWatt) => new() { Quantity = kelvinPerWatt };
	...
	/// <returns>A new ThermalResistance instance.</returns>
	public static new ThermalResistance FromFahrenheitHourPerBtu(float fahrenheitHourPerBtu) => new() { Quantity = fahrenheitHourPerBtu };
}
