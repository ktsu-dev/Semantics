...
public readonly partial record struct BulkModulus<T> : IVector0<BulkModulus<T>, T>, IPhysicalQuantity<BulkModulus<T>, T>
	where T : struct, INumber<T>
{
	...
	public static BulkModulus<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<BulkModulus<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<BulkModulus<T>, T>(this, other);

	/// <summary>Adds two <see cref="BulkModulus{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static BulkModulus<T> operator +(BulkModulus<T> left, BulkModulus<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="BulkModulus{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static BulkModulus<T> operator -(BulkModulus<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="BulkModulus{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static BulkModulus<T> operator *(BulkModulus<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="BulkModulus{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static BulkModulus<T> operator *(T left, BulkModulus<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="BulkModulus{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static BulkModulus<T> operator /(BulkModulus<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="BulkModulus{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(BulkModulus<T> left, BulkModulus<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(BulkModulus<T> left, BulkModulus<T> right) => left.Quantity < right.Quantity;
	...
	/// <returns>A new BulkModulus instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static BulkModulus<T> FromKilopascal(T value) => Create(Vector0Guards.EnsureNonNegative((value * MetricMagnitudes.Values<T>.Kilo), nameof(value)));
	...
	/// <returns>A new BulkModulus instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static BulkModulus<T> FromBar(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.BarToPascals), nameof(value)));
	...
	/// <returns>A new BulkModulus instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static BulkModulus<T> FromAtmosphere(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.AtmosphereToPascals), nameof(value)));
	...
	/// <returns>A new BulkModulus instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static BulkModulus<T> FromPsi(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.PsiToPascals), nameof(value)));
	...
	/// <returns>A new BulkModulus instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static BulkModulus<T> FromTorr(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.TorrToPascals), nameof(value)));
	...
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static BulkModulus<T> operator -(BulkModulus<T> left, BulkModulus<T> right) => Create(T.Abs(left.Quantity - right.Quantity));
}
