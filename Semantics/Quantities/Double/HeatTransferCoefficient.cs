...
/// <summary>
/// Represents a heat transfer coefficient quantity with double precision.
/// </summary>
public sealed record HeatTransferCoefficient
{
	...
	public Generic.HeatTransferCoefficient<double> Value { get; init; } = new();
	...
	public static HeatTransferCoefficient FromWattsPerSquareMeterKelvin(double wattsPerSquareMeterKelvin) => new() { Value = Generic.HeatTransferCoefficient<double>.FromWattsPerSquareMeterKelvin(wattsPerSquareMeterKelvin) };
