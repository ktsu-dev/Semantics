...
/// <summary>
/// Extent through the thinnest dimension.
/// Semantic overload of <see cref="Length{T}"/>.
/// </summary>
/// <typeparam name="T">The numeric storage type.</typeparam>
public readonly partial record struct Thickness<T> : IVector0<Thickness<T>, T>, IPhysicalQuantity<Thickness<T>, T>
	where T : struct, INumber<T>
{
	...
	public static Thickness<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<Thickness<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<Thickness<T>, T>(this, other);

	/// <summary>Adds two <see cref="Thickness{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Thickness<T> operator +(Thickness<T> left, Thickness<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="Thickness{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Thickness<T> operator -(Thickness<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="Thickness{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Thickness<T> operator *(Thickness<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="Thickness{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Thickness<T> operator *(T left, Thickness<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="Thickness{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Thickness<T> operator /(Thickness<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="Thickness{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(Thickness<T> left, Thickness<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(Thickness<T> left, Thickness<T> right) => left.Quantity < right.Quantity;
	...
	/// <summary>
	/// Creates a new Thickness from a value in Meter.
	/// </summary>
	...
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Thickness<T> operator -(Thickness<T> left, Thickness<T> right) => Create(T.Abs(left.Quantity - right.Quantity));
}
