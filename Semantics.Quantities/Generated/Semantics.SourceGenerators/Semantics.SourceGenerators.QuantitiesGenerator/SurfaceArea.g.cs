...
public readonly partial record struct SurfaceArea<T> : IVector0<SurfaceArea<T>, T>, IPhysicalQuantity<SurfaceArea<T>, T>
	where T : struct, INumber<T>
{
	...
	public static SurfaceArea<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<SurfaceArea<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<SurfaceArea<T>, T>(this, other);

	/// <summary>Adds two <see cref="SurfaceArea{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SurfaceArea<T> operator +(SurfaceArea<T> left, SurfaceArea<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="SurfaceArea{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SurfaceArea<T> operator -(SurfaceArea<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="SurfaceArea{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SurfaceArea<T> operator *(SurfaceArea<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="SurfaceArea{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SurfaceArea<T> operator *(T left, SurfaceArea<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="SurfaceArea{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SurfaceArea<T> operator /(SurfaceArea<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="SurfaceArea{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(SurfaceArea<T> left, SurfaceArea<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(SurfaceArea<T> left, SurfaceArea<T> right) => left.Quantity < right.Quantity;
	...
	/// <returns>A new SurfaceArea instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SurfaceArea<T> FromSquareKilometer(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.SquareKilometerToSquareMeters), nameof(value)));
	...
	/// <returns>A new SurfaceArea instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SurfaceArea<T> FromSquareCentimeter(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.SquareCentimeterToSquareMeters), nameof(value)));
	...
	/// <returns>A new SurfaceArea instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SurfaceArea<T> FromSquareFoot(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.SquareFootToSquareMeters), nameof(value)));
	...
	/// <returns>A new SurfaceArea instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SurfaceArea<T> FromSquareInch(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.SquareInchToSquareMeters), nameof(value)));
	...
	/// <returns>A new SurfaceArea instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SurfaceArea<T> FromSquareMile(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.SquareMileToSquareMeters), nameof(value)));
	...
	/// <returns>A new SurfaceArea instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SurfaceArea<T> FromHectare(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.HectareToSquareMeters), nameof(value)));
	...
	/// <returns>A new SurfaceArea instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SurfaceArea<T> FromAcre(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.AcreToSquareMeters), nameof(value)));
	...
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SurfaceArea<T> operator -(SurfaceArea<T> left, SurfaceArea<T> right) => Create(T.Abs(left.Quantity - right.Quantity));
}
