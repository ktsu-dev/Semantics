...
public sealed record SoundPressure : Generic.SoundPressure<float>
{
	...
	public static new SoundPressure FromPascals(float pascals) => new() { Value = pascals };
	...
	/// <returns>A new SoundPressure instance.</returns>
	public static new SoundPressure FromMicropascals(float micropascals) => new() { Value = micropascals };
	...
	/// <returns>A new SoundPressure instance.</returns>
	public static new SoundPressure FromBars(float bars) => new() { Value = bars };
}
