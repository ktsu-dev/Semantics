...
/// <summary>
/// Represents a 2D velocity vector with float precision.
/// </summary>
public sealed record Velocity2D : Generic.Velocity2D<float>
{
	...
	public static Velocity2D Create(Vector2f value) => new() { Value = value };
	...
	public Vector2f InMetersPerSecond() => Value;
	...
	public static Velocity2D operator *(Velocity2D velocity, float scalar)
	{
	...
	public static Velocity2D operator *(float scalar, Velocity2D velocity)
	{
		ArgumentNullException.ThrowIfNull(velocity);
	...
	/// <summary>
	/// Calculates the dot product of two velocity vectors, representing kinetic energy per unit mass.
	/// </summary>
	/// <param name="other">The other velocity vector.</param>
	/// <returns>The dot product as energy per unit mass (L² T⁻²).</returns>
