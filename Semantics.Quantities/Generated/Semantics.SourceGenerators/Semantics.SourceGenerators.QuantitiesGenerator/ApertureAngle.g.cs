...
public readonly partial record struct ApertureAngle<T> : IVector0<ApertureAngle<T>, T>, IPhysicalQuantity<ApertureAngle<T>, T>
	where T : struct, INumber<T>
{
	...
	public static ApertureAngle<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<ApertureAngle<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<ApertureAngle<T>, T>(this, other);

	/// <summary>Adds two <see cref="ApertureAngle{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ApertureAngle<T> operator +(ApertureAngle<T> left, ApertureAngle<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="ApertureAngle{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ApertureAngle<T> operator -(ApertureAngle<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="ApertureAngle{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ApertureAngle<T> operator *(ApertureAngle<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="ApertureAngle{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ApertureAngle<T> operator *(T left, ApertureAngle<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="ApertureAngle{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ApertureAngle<T> operator /(ApertureAngle<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="ApertureAngle{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(ApertureAngle<T> left, ApertureAngle<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(ApertureAngle<T> left, ApertureAngle<T> right) => left.Quantity < right.Quantity;
	...
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ApertureAngle<T> operator -(ApertureAngle<T> left, ApertureAngle<T> right) => Create(T.Abs(left.Quantity - right.Quantity));
}
