...
public readonly partial record struct SoundPressure<T> : IVector0<SoundPressure<T>, T>, IPhysicalQuantity<SoundPressure<T>, T>
	where T : struct, INumber<T>
{
	...
	public static SoundPressure<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<SoundPressure<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<SoundPressure<T>, T>(this, other);

	/// <summary>Adds two <see cref="SoundPressure{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundPressure<T> operator +(SoundPressure<T> left, SoundPressure<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="SoundPressure{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundPressure<T> operator -(SoundPressure<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="SoundPressure{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundPressure<T> operator *(SoundPressure<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="SoundPressure{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundPressure<T> operator *(T left, SoundPressure<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="SoundPressure{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundPressure<T> operator /(SoundPressure<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="SoundPressure{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(SoundPressure<T> left, SoundPressure<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(SoundPressure<T> left, SoundPressure<T> right) => left.Quantity < right.Quantity;
	...
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundPressure<T> operator -(SoundPressure<T> left, SoundPressure<T> right) => Create(T.Abs(left.Quantity - right.Quantity));
}
