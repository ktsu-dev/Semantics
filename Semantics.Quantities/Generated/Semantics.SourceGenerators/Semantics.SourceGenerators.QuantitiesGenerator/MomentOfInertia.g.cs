...
public readonly partial record struct MomentOfInertia<T> : IVector0<MomentOfInertia<T>, T>, IPhysicalQuantity<MomentOfInertia<T>, T>
	where T : struct, INumber<T>
{
	...
	public static MomentOfInertia<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<MomentOfInertia<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<MomentOfInertia<T>, T>(this, other);

	/// <summary>Adds two <see cref="MomentOfInertia{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static MomentOfInertia<T> operator +(MomentOfInertia<T> left, MomentOfInertia<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="MomentOfInertia{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static MomentOfInertia<T> operator -(MomentOfInertia<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="MomentOfInertia{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static MomentOfInertia<T> operator *(MomentOfInertia<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="MomentOfInertia{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static MomentOfInertia<T> operator *(T left, MomentOfInertia<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="MomentOfInertia{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static MomentOfInertia<T> operator /(MomentOfInertia<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="MomentOfInertia{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(MomentOfInertia<T> left, MomentOfInertia<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(MomentOfInertia<T> left, MomentOfInertia<T> right) => left.Quantity < right.Quantity;
