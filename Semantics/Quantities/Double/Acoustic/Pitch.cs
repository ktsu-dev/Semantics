...
public sealed record Pitch : Generic.Pitch<double>
{
	...
	public static new Pitch FromHertz(double hertz) => new() { Value = hertz };
	...
	/// <returns>A new Pitch instance.</returns>
	public static new Pitch FromMels(double mels) => new() { Value = mels };
	...
	/// <returns>A new Pitch instance.</returns>
	public static new Pitch FromBarks(double barks) => new() { Value = barks };
}
