...
public sealed record Displacement3D : Generic.Displacement3D<float>
{
	...
	public static new Displacement3D FromMeters(float x, float y, float z) => Create(x, y, z);
	...
	/// <returns>A new Displacement3D instance.</returns>
	public static new Displacement3D FromMeters(Vector3 meters) => Create(new Vector3f(meters));
