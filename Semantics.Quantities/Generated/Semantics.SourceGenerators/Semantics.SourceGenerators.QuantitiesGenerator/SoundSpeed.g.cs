...
/// <summary>
/// Speed of sound propagation in a medium.
/// Semantic overload of <see cref="Speed{T}"/>.
/// </summary>
/// <typeparam name="T">The numeric storage type.</typeparam>
public readonly partial record struct SoundSpeed<T> : IVector0<SoundSpeed<T>, T>, IPhysicalQuantity<SoundSpeed<T>, T>
	where T : struct, INumber<T>
{
	...
	public static SoundSpeed<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<SoundSpeed<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<SoundSpeed<T>, T>(this, other);

	/// <summary>Adds two <see cref="SoundSpeed{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundSpeed<T> operator +(SoundSpeed<T> left, SoundSpeed<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="SoundSpeed{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundSpeed<T> operator -(SoundSpeed<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="SoundSpeed{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundSpeed<T> operator *(SoundSpeed<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="SoundSpeed{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundSpeed<T> operator *(T left, SoundSpeed<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="SoundSpeed{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundSpeed<T> operator /(SoundSpeed<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="SoundSpeed{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(SoundSpeed<T> left, SoundSpeed<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(SoundSpeed<T> left, SoundSpeed<T> right) => left.Quantity < right.Quantity;
	...
	/// <summary>
	/// Creates a new SoundSpeed from a value in MeterPerSecond.
	/// </summary>
	...
	/// <returns>A new SoundSpeed instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SoundSpeed<T> FromKilometerPerHour(T value) => Create(Vector0Guards.EnsureNonNegative((value * T.CreateChecked(Units.ConversionConstants.KilometerPerHourToMeterPerSecond)), nameof(value)));

	/// <summary>
	/// Creates a new SoundSpeed from a value in MilePerHour.
	/// </summary>
	/// <param name="value">The value in MilePerHour.</param>
	/// <returns>A new SoundSpeed instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SoundSpeed<T> FromMilePerHour(T value) => Create(Vector0Guards.EnsureNonNegative((value * T.CreateChecked(Units.ConversionConstants.MilePerHourToMeterPerSecond)), nameof(value)));

	/// <summary>
	/// Creates a new SoundSpeed from a value in FootPerSecond.
	/// </summary>
	/// <param name="value">The value in FootPerSecond.</param>
	/// <returns>A new SoundSpeed instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SoundSpeed<T> FromFootPerSecond(T value) => Create(Vector0Guards.EnsureNonNegative((value * T.CreateChecked(Units.ConversionConstants.FootPerSecondToMeterPerSecond)), nameof(value)));
	...
	/// <returns>A new SoundSpeed instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SoundSpeed<T> FromKnot(T value) => Create(Vector0Guards.EnsureNonNegative((value * T.CreateChecked(Units.ConversionConstants.KnotToMeterPerSecond)), nameof(value)));
	...
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundSpeed<T> operator -(SoundSpeed<T> left, SoundSpeed<T> right) => Create(T.Abs(left.Quantity - right.Quantity));
}
