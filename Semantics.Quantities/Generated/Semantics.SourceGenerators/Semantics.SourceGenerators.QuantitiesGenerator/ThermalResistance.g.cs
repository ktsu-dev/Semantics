...
public readonly partial record struct ThermalResistance<T> : IVector0<ThermalResistance<T>, T>, IPhysicalQuantity<ThermalResistance<T>, T>
	where T : struct, INumber<T>
{
	...
	public static ThermalResistance<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<ThermalResistance<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<ThermalResistance<T>, T>(this, other);

	/// <summary>Adds two <see cref="ThermalResistance{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ThermalResistance<T> operator +(ThermalResistance<T> left, ThermalResistance<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="ThermalResistance{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ThermalResistance<T> operator -(ThermalResistance<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="ThermalResistance{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ThermalResistance<T> operator *(ThermalResistance<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="ThermalResistance{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ThermalResistance<T> operator *(T left, ThermalResistance<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="ThermalResistance{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ThermalResistance<T> operator /(ThermalResistance<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="ThermalResistance{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(ThermalResistance<T> left, ThermalResistance<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(ThermalResistance<T> left, ThermalResistance<T> right) => left.Quantity < right.Quantity;
	...
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ThermalResistance<T> operator -(ThermalResistance<T> left, ThermalResistance<T> right) => Create(T.Abs(left.Quantity - right.Quantity));
}
