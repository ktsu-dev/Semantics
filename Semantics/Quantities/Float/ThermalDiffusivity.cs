...
public sealed record ThermalDiffusivity
{
	...
	public static new ThermalDiffusivity FromSquareMetersPerSecond(float squareMetersPerSecond) => new() { Value = Generic.ThermalDiffusivity<float>.FromSquareMetersPerSecond(squareMetersPerSecond) };
	...
	/// <returns>A new ThermalDiffusivity instance.</returns>
	public static new ThermalDiffusivity FromSquareFeetPerHour(float squareFeetPerHour) => new() { Value = Generic.ThermalDiffusivity<float>.FromSquareFeetPerHour(squareFeetPerHour) };
	...
	/// <returns>A new ThermalDiffusivity instance.</returns>
	public static new ThermalDiffusivity FromSquareCentimetersPerSecond(float squareCentimetersPerSecond) => new() { Value = Generic.ThermalDiffusivity<float>.FromSquareCentimetersPerSecond(squareCentimetersPerSecond) };
