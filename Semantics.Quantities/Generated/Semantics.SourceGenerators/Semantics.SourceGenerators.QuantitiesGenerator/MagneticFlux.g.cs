...
public partial record MagneticFlux<T> : PhysicalQuantity<MagneticFlux<T>, T>, IVector0<MagneticFlux<T>, T>
	where T : struct, INumber<T>
{
	...
	public override DimensionInfo Dimension => PhysicalDimensions.MagneticFlux;
