...
public sealed record SoundPowerLevel
{
	...
	public Generic.SoundPowerLevel<float> Value { get; init; } = new();
	...
	public static new SoundPowerLevel FromDecibels(float decibels) => new() { Value = Generic.SoundPowerLevel<float>.FromDecibels(decibels) };
