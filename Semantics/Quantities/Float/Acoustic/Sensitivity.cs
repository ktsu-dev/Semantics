...
public sealed record Sensitivity : Generic.Sensitivity<float>
{
	...
	public static new Sensitivity FromDbSplPerWatt(float dbSplPerWatt) => (Sensitivity)Create(dbSplPerWatt);
	...
	/// <returns>A new Sensitivity instance.</returns>
	public static new Sensitivity FromDbSplPerVolt(float dbSplPerVolt) => (Sensitivity)Create(dbSplPerVolt);
	...
	/// <returns>A new Sensitivity instance.</returns>
	public static new Sensitivity FromMvPerPa(float mvPerPa) => (Sensitivity)Create(mvPerPa);
}
