...
public readonly partial record struct Exposure<T> : IVector0<Exposure<T>, T>, IPhysicalQuantity<Exposure<T>, T>
	where T : struct, INumber<T>
{
	...
	public static Exposure<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<Exposure<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<Exposure<T>, T>(this, other);

	/// <summary>Adds two <see cref="Exposure{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Exposure<T> operator +(Exposure<T> left, Exposure<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="Exposure{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Exposure<T> operator -(Exposure<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="Exposure{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Exposure<T> operator *(Exposure<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="Exposure{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Exposure<T> operator *(T left, Exposure<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="Exposure{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Exposure<T> operator /(Exposure<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="Exposure{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(Exposure<T> left, Exposure<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(Exposure<T> left, Exposure<T> right) => left.Quantity < right.Quantity;
	...
	/// <returns>A new <see cref="Exposure{T}"/> instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static Exposure<T> FromRoentgen(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.RoentgenToCoulombsPerKilogram), nameof(value)));
