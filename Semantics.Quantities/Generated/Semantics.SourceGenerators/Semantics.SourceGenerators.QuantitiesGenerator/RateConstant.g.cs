...
public readonly partial record struct RateConstant<T> : IVector0<RateConstant<T>, T>, IPhysicalQuantity<RateConstant<T>, T>
	where T : struct, INumber<T>
{
	...
	public static RateConstant<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<RateConstant<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<RateConstant<T>, T>(this, other);

	/// <summary>Adds two <see cref="RateConstant{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static RateConstant<T> operator +(RateConstant<T> left, RateConstant<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="RateConstant{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static RateConstant<T> operator -(RateConstant<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="RateConstant{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static RateConstant<T> operator *(RateConstant<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="RateConstant{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static RateConstant<T> operator *(T left, RateConstant<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="RateConstant{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static RateConstant<T> operator /(RateConstant<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="RateConstant{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(RateConstant<T> left, RateConstant<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(RateConstant<T> left, RateConstant<T> right) => left.Quantity < right.Quantity;
