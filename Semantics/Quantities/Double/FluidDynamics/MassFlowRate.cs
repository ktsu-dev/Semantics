...
public sealed record MassFlowRate
{
	...
	public Generic.MassFlowRate<double> Value { get; init; } = new();
	...
	public static MassFlowRate FromKilogramsPerSecond(double kilogramsPerSecond) => new() { Value = Generic.MassFlowRate<double>.FromKilogramsPerSecond(kilogramsPerSecond) };
