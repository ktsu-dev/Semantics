...
public readonly partial record struct RefractiveIndex<T> : IVector0<RefractiveIndex<T>, T>, IPhysicalQuantity<RefractiveIndex<T>, T>
	where T : struct, INumber<T>
{
	...
	public static RefractiveIndex<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<RefractiveIndex<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<RefractiveIndex<T>, T>(this, other);

	/// <summary>Adds two <see cref="RefractiveIndex{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static RefractiveIndex<T> operator +(RefractiveIndex<T> left, RefractiveIndex<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="RefractiveIndex{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static RefractiveIndex<T> operator -(RefractiveIndex<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="RefractiveIndex{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static RefractiveIndex<T> operator *(RefractiveIndex<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="RefractiveIndex{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static RefractiveIndex<T> operator *(T left, RefractiveIndex<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="RefractiveIndex{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static RefractiveIndex<T> operator /(RefractiveIndex<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="RefractiveIndex{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(RefractiveIndex<T> left, RefractiveIndex<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(RefractiveIndex<T> left, RefractiveIndex<T> right) => left.Quantity < right.Quantity;
	...
	/// <returns>A new RefractiveIndex instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static RefractiveIndex<T> FromDegree(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.DegreeToRadians), nameof(value)));
	...
	/// <returns>A new RefractiveIndex instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static RefractiveIndex<T> FromGradian(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.GradianToRadians), nameof(value)));
	...
	/// <returns>A new RefractiveIndex instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static RefractiveIndex<T> FromRevolution(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.RevolutionToRadians), nameof(value)));
	...
	/// <returns>A new RefractiveIndex instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static RefractiveIndex<T> FromMilliradian(T value) => Create(Vector0Guards.EnsureNonNegative((value * MetricMagnitudes.Values<T>.Milli), nameof(value)));
	...
	/// <returns>A new RefractiveIndex instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static RefractiveIndex<T> FromPercent(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.PercentToRatio), nameof(value)));

	/// <summary>
	/// Creates a new RefractiveIndex from a value in PartPerMillion.
	/// </summary>
	/// <param name="value">The value in PartPerMillion.</param>
	/// <returns>A new RefractiveIndex instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static RefractiveIndex<T> FromPartPerMillion(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.PartPerMillionToRatio), nameof(value)));

	/// <summary>
	/// Creates a new RefractiveIndex from a value in PartPerBillion.
	/// </summary>
	/// <param name="value">The value in PartPerBillion.</param>
	/// <returns>A new RefractiveIndex instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static RefractiveIndex<T> FromPartPerBillion(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.PartPerBillionToRatio), nameof(value)));
	...
	/// <returns>A new RefractiveIndex instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static RefractiveIndex<T> FromPercentByWeight(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.PercentByWeightToRatio), nameof(value)));
	...
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static RefractiveIndex<T> operator -(RefractiveIndex<T> left, RefractiveIndex<T> right) => Create(T.Abs(left.Quantity - right.Quantity));
}
