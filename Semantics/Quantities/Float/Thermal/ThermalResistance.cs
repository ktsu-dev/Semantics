...
public sealed record ThermalResistance
{
	...
	public static ThermalResistance FromKelvinPerWatt(float kelvinPerWatt) => new() { Value = Generic.ThermalResistance<float>.FromKelvinPerWatt(kelvinPerWatt) };
	...
	/// <returns>A new ThermalResistance instance.</returns>
	public static ThermalResistance FromFahrenheitHourPerBtu(float fahrenheitHourPerBtu) => new() { Value = Generic.ThermalResistance<float>.FromFahrenheitHourPerBtu(fahrenheitHourPerBtu) };
