...
public static class PhysicalDimensions
{
	...
	/// <summary>Gets a read-only collection of all standard physical dimensions.</summary>
	public static IReadOnlySet<PhysicalDimension> All { get; } = new HashSet<PhysicalDimension>
	{
		Dimensionless,
		Length,
		Mass,
