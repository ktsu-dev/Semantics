...
public sealed record ThermalDiffusivity : Generic.ThermalDiffusivity<float>
{
	...
	public static new ThermalDiffusivity FromSquareMetersPerSecond(float squareMetersPerSecond) => new() { Quantity = squareMetersPerSecond };
	...
	/// <returns>A new ThermalDiffusivity instance.</returns>
	public static new ThermalDiffusivity FromSquareFeetPerHour(float squareFeetPerHour) => new() { Quantity = squareFeetPerHour };
	...
	/// <returns>A new ThermalDiffusivity instance.</returns>
	public static new ThermalDiffusivity FromSquareCentimetersPerSecond(float squareCentimetersPerSecond) => new() { Quantity = squareCentimetersPerSecond };
}
