...
public sealed record Acceleration3D : Generic.Acceleration3D<float>
{
	...
	public static new Acceleration3D FromMetersPerSecondSquared(float x, float y, float z) => Create(x, y, z);
	...
	/// <returns>A new Acceleration3D instance.</returns>
	public static new Acceleration3D FromMetersPerSecondSquared(Vector3 metersPerSecondSquared) => Create(new Vector3f(metersPerSecondSquared));
