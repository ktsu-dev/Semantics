...
public partial record AngularJerkMagnitude<T> : PhysicalQuantity<AngularJerkMagnitude<T>, T>, IVector0<AngularJerkMagnitude<T>, T>
	where T : struct, INumber<T>
{
	...
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static AngularAccelerationMagnitude<T> operator *(AngularJerkMagnitude<T> left, Duration<T> right) => Multiply<AngularAccelerationMagnitude<T>>(left, right);
}
