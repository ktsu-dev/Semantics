...
public readonly partial record struct ElectricFlux<T> : IVector0<ElectricFlux<T>, T>, IPhysicalQuantity<ElectricFlux<T>, T>
	where T : struct, INumber<T>
{
	...
	public static ElectricFlux<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<ElectricFlux<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<ElectricFlux<T>, T>(this, other);

	/// <summary>Adds two <see cref="ElectricFlux{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ElectricFlux<T> operator +(ElectricFlux<T> left, ElectricFlux<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="ElectricFlux{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ElectricFlux<T> operator -(ElectricFlux<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="ElectricFlux{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ElectricFlux<T> operator *(ElectricFlux<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="ElectricFlux{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ElectricFlux<T> operator *(T left, ElectricFlux<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="ElectricFlux{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ElectricFlux<T> operator /(ElectricFlux<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="ElectricFlux{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(ElectricFlux<T> left, ElectricFlux<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(ElectricFlux<T> left, ElectricFlux<T> right) => left.Quantity < right.Quantity;
	...
	public static ElectricFlux<T> FromVoltMeter(T value) => Create(Vector0Guards.EnsureNonNegative(value, nameof(value)));
	...
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ElectricFlux<T> operator -(ElectricFlux<T> left, ElectricFlux<T> right) => Create(T.Abs(left.Quantity - right.Quantity));

	/// <summary>
	/// Divides ElectricFlux by Area to produce ElectricFieldMagnitude.
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ElectricFieldMagnitude<T> operator /(ElectricFlux<T> left, Area<T> right) => ElectricFieldMagnitude<T>.Create(left.Quantity / right.Quantity);

	/// <summary>
	/// Divides ElectricFlux by ElectricFieldMagnitude to produce Area.
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Area<T> operator /(ElectricFlux<T> left, ElectricFieldMagnitude<T> right) => Area<T>.Create(left.Quantity / right.Quantity);
}
