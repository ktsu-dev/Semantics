...
public sealed record ReverberationTime
{
	...
	public static new ReverberationTime FromSeconds(float seconds) => new() { Value = Generic.ReverberationTime<float>.FromSeconds(seconds) };
	...
	/// <returns>A new ReverberationTime instance.</returns>
	public static new ReverberationTime FromT60(float t60) => new() { Value = Generic.ReverberationTime<float>.FromT60(t60) };
	...
	/// <returns>A new ReverberationTime instance.</returns>
	public static new ReverberationTime FromT30(float t30) => new() { Value = Generic.ReverberationTime<float>.FromT30(t30) };
