...
public abstract class GeneratorBase<T>(string metadataFilename) : IIncrementalGenerator
{
	...
	{
		// Keep in step with COPYRIGHT.md; ktsu.Sdk syncs .editorconfig's file_header_template from it.
		codeBlocker.WriteLine("// Copyright (c) 2023-2026 ktsu-dev contributors");
