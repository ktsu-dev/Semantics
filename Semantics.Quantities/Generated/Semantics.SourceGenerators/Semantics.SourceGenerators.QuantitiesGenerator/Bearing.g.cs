...
public readonly partial record struct Bearing<T> : IVector1<Bearing<T>, T>, IPhysicalQuantity<Bearing<T>, T>
	where T : struct, INumber<T>
{
	...
	public static Bearing<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<Bearing<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<Bearing<T>, T>(this, other);

	/// <summary>Adds two <see cref="Bearing{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Bearing<T> operator +(Bearing<T> left, Bearing<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Subtracts one <see cref="Bearing{T}"/> from another.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Bearing<T> operator -(Bearing<T> left, Bearing<T> right) => Create(left.Quantity - right.Quantity);

	/// <summary>Negates a <see cref="Bearing{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Bearing<T> operator -(Bearing<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="Bearing{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Bearing<T> operator *(Bearing<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="Bearing{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Bearing<T> operator *(T left, Bearing<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="Bearing{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Bearing<T> operator /(Bearing<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="Bearing{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(Bearing<T> left, Bearing<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(Bearing<T> left, Bearing<T> right) => left.Quantity < right.Quantity;
	...
	/// <returns>A new Bearing instance.</returns>
	public static Bearing<T> FromDegree(T value) => Create((value * Units.ConversionConstants.Values<T>.DegreeToRadians));
	...
	/// <returns>A new Bearing instance.</returns>
	public static Bearing<T> FromGradian(T value) => Create((value * Units.ConversionConstants.Values<T>.GradianToRadians));
	...
	/// <returns>A new Bearing instance.</returns>
	public static Bearing<T> FromRevolution(T value) => Create((value * Units.ConversionConstants.Values<T>.RevolutionToRadians));
	...
	/// <returns>A new Bearing instance.</returns>
	public static Bearing<T> FromMilliradian(T value) => Create((value * MetricMagnitudes.Values<T>.Milli));
