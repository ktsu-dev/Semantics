...
public sealed record Displacement2D : Generic.Displacement2D<float>
{
	...
	public static new Displacement2D FromMeters(float x, float y) => Create(x, y);
	...
	/// <returns>A new Displacement2D instance.</returns>
	public static new Displacement2D FromMeters(Vector2 meters) => Create(new Vector2f(meters));
