...
public readonly partial record struct MolarMass<T> : IVector0<MolarMass<T>, T>, IPhysicalQuantity<MolarMass<T>, T>
	where T : struct, INumber<T>
{
	...
	public static MolarMass<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<MolarMass<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<MolarMass<T>, T>(this, other);

	/// <summary>Adds two <see cref="MolarMass{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static MolarMass<T> operator +(MolarMass<T> left, MolarMass<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="MolarMass{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static MolarMass<T> operator -(MolarMass<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="MolarMass{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static MolarMass<T> operator *(MolarMass<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="MolarMass{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static MolarMass<T> operator *(T left, MolarMass<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="MolarMass{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static MolarMass<T> operator /(MolarMass<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="MolarMass{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(MolarMass<T> left, MolarMass<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(MolarMass<T> left, MolarMass<T> right) => left.Quantity < right.Quantity;
	...
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Mass<T> operator *(MolarMass<T> left, AmountOfSubstance<T> right) => Mass<T>.Create(left.Quantity * right.Quantity);
}
