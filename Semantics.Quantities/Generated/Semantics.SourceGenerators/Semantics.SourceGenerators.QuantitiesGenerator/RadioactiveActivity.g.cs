...
public readonly partial record struct RadioactiveActivity<T> : IVector0<RadioactiveActivity<T>, T>, IPhysicalQuantity<RadioactiveActivity<T>, T>
	where T : struct, INumber<T>
{
	...
	public static RadioactiveActivity<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<RadioactiveActivity<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<RadioactiveActivity<T>, T>(this, other);

	/// <summary>Adds two <see cref="RadioactiveActivity{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static RadioactiveActivity<T> operator +(RadioactiveActivity<T> left, RadioactiveActivity<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="RadioactiveActivity{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static RadioactiveActivity<T> operator -(RadioactiveActivity<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="RadioactiveActivity{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static RadioactiveActivity<T> operator *(RadioactiveActivity<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="RadioactiveActivity{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static RadioactiveActivity<T> operator *(T left, RadioactiveActivity<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="RadioactiveActivity{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static RadioactiveActivity<T> operator /(RadioactiveActivity<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="RadioactiveActivity{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(RadioactiveActivity<T> left, RadioactiveActivity<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(RadioactiveActivity<T> left, RadioactiveActivity<T> right) => left.Quantity < right.Quantity;
	...
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static RadioactiveActivity<T> operator -(RadioactiveActivity<T> left, RadioactiveActivity<T> right) => Create(T.Abs(left.Quantity - right.Quantity));
}
