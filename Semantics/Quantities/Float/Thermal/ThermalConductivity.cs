...
public sealed record ThermalConductivity
{
	...
	public static ThermalConductivity FromWattsPerMeterKelvin(float wattsPerMeterKelvin) => new() { Value = Generic.ThermalConductivity<float>.FromWattsPerMeterKelvin(wattsPerMeterKelvin) };
	...
	/// <returns>A new ThermalConductivity instance.</returns>
	public static ThermalConductivity FromBtuPerHourFootFahrenheit(float btuPerHourFootFahrenheit) => new() { Value = Generic.ThermalConductivity<float>.FromBtuPerHourFootFahrenheit(btuPerHourFootFahrenheit) };
