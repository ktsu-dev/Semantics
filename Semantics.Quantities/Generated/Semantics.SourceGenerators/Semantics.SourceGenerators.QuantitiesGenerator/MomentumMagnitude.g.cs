...
public readonly partial record struct MomentumMagnitude<T> : IVector0<MomentumMagnitude<T>, T>, IPhysicalQuantity<MomentumMagnitude<T>, T>
	where T : struct, INumber<T>
{
	...
	public static MomentumMagnitude<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<MomentumMagnitude<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<MomentumMagnitude<T>, T>(this, other);

	/// <summary>Adds two <see cref="MomentumMagnitude{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static MomentumMagnitude<T> operator +(MomentumMagnitude<T> left, MomentumMagnitude<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="MomentumMagnitude{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static MomentumMagnitude<T> operator -(MomentumMagnitude<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="MomentumMagnitude{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static MomentumMagnitude<T> operator *(MomentumMagnitude<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="MomentumMagnitude{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static MomentumMagnitude<T> operator *(T left, MomentumMagnitude<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="MomentumMagnitude{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static MomentumMagnitude<T> operator /(MomentumMagnitude<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="MomentumMagnitude{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(MomentumMagnitude<T> left, MomentumMagnitude<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(MomentumMagnitude<T> left, MomentumMagnitude<T> right) => left.Quantity < right.Quantity;
	...
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Mass<T> operator /(MomentumMagnitude<T> left, Speed<T> right) => Mass<T>.Create(left.Quantity / right.Quantity);

	/// <summary>
	/// Divides MomentumMagnitude by Mass to produce Speed.
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Speed<T> operator /(MomentumMagnitude<T> left, Mass<T> right) => Speed<T>.Create(left.Quantity / right.Quantity);

	/// <summary>
	/// Divides MomentumMagnitude by Duration to produce ForceMagnitude.
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ForceMagnitude<T> operator /(MomentumMagnitude<T> left, Duration<T> right) => ForceMagnitude<T>.Create(left.Quantity / right.Quantity);

	/// <summary>
	/// Divides MomentumMagnitude by ForceMagnitude to produce Duration.
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Duration<T> operator /(MomentumMagnitude<T> left, ForceMagnitude<T> right) => Duration<T>.Create(left.Quantity / right.Quantity);
}
