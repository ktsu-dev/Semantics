...
public sealed record VolumetricFlowRate
{
	...
	public static VolumetricFlowRate FromCubicMetersPerSecond(float cubicMetersPerSecond) => new() { Value = Generic.VolumetricFlowRate<float>.FromCubicMetersPerSecond(cubicMetersPerSecond) };
