...
public sealed record Exposure
{
	...
	public static new Exposure FromCoulombsPerKilogram(float coulombsPerKilogram) => new() { Value = Generic.Exposure<float>.FromCoulombsPerKilogram(coulombsPerKilogram) };
