...
public sealed record ThermalExpansion
{
	...
	public static ThermalExpansion FromPerKelvin(float perKelvin) => new() { Value = Generic.ThermalExpansion<float>.FromPerKelvin(perKelvin) };
	...
	/// <returns>A new ThermalExpansion instance.</returns>
	public static ThermalExpansion FromPerCelsius(float perCelsius) => new() { Value = Generic.ThermalExpansion<float>.FromPerCelsius(perCelsius) };
	...
	/// <returns>A new ThermalExpansion instance.</returns>
	public static ThermalExpansion FromPerFahrenheit(float perFahrenheit) => new() { Value = Generic.ThermalExpansion<float>.FromPerFahrenheit(perFahrenheit) };
