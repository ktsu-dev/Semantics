	...
	where T : struct, INumber<T>
{
	...
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ElectricFieldMagnitude<T> operator /(ElectricFlux<T> left, Area<T> right) => Divide<ElectricFieldMagnitude<T>>(left, right);

	/// <summary>
	/// Divides ElectricFlux by ElectricFieldMagnitude to produce Area.
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Area<T> operator /(ElectricFlux<T> left, ElectricFieldMagnitude<T> right) => Divide<Area<T>>(left, right);
}
