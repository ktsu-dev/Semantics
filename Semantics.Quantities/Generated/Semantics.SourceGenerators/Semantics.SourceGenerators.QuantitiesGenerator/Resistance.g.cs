...
public readonly partial record struct Resistance<T> : IVector0<Resistance<T>, T>, IPhysicalQuantity<Resistance<T>, T>
	where T : struct, INumber<T>
{
	...
	public static Resistance<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<Resistance<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<Resistance<T>, T>(this, other);

	/// <summary>Adds two <see cref="Resistance{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Resistance<T> operator +(Resistance<T> left, Resistance<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="Resistance{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Resistance<T> operator -(Resistance<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="Resistance{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Resistance<T> operator *(Resistance<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="Resistance{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Resistance<T> operator *(T left, Resistance<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="Resistance{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Resistance<T> operator /(Resistance<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="Resistance{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(Resistance<T> left, Resistance<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(Resistance<T> left, Resistance<T> right) => left.Quantity < right.Quantity;
	...
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static VoltageMagnitude<T> operator *(Resistance<T> left, CurrentMagnitude<T> right) => VoltageMagnitude<T>.Create(left.Quantity * right.Quantity);

	/// <summary>
	/// Multiplies Resistance by Current1D to produce Voltage.
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Voltage<T> operator *(Resistance<T> left, Current1D<T> right) => Voltage<T>.Create(left.Quantity * right.Quantity);
}
