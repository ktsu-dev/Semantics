...
public readonly partial record struct EquivalentDose<T> : IVector0<EquivalentDose<T>, T>, IPhysicalQuantity<EquivalentDose<T>, T>
	where T : struct, INumber<T>
{
	...
	public static EquivalentDose<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<EquivalentDose<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<EquivalentDose<T>, T>(this, other);

	/// <summary>Adds two <see cref="EquivalentDose{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static EquivalentDose<T> operator +(EquivalentDose<T> left, EquivalentDose<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="EquivalentDose{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static EquivalentDose<T> operator -(EquivalentDose<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="EquivalentDose{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static EquivalentDose<T> operator *(EquivalentDose<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="EquivalentDose{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static EquivalentDose<T> operator *(T left, EquivalentDose<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="EquivalentDose{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static EquivalentDose<T> operator /(EquivalentDose<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="EquivalentDose{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(EquivalentDose<T> left, EquivalentDose<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(EquivalentDose<T> left, EquivalentDose<T> right) => left.Quantity < right.Quantity;
	...
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static EquivalentDose<T> operator -(EquivalentDose<T> left, EquivalentDose<T> right) => Create(T.Abs(left.Quantity - right.Quantity));
}
