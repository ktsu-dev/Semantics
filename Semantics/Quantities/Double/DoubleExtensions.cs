...
public static class DoubleExtensions
{
	...
	public static Length Micrometers(this double value) => Length.FromMeters(ConvertToBaseUnit(value, Units.Micrometer));

	/// <summary>Creates a Length from a value in nanometers.</summary>
	public static Length Nanometers(this double value) => Length.FromMeters(ConvertToBaseUnit(value, Units.Nanometer));
	...
	public static Position2D Kilometers2D(this Vector2 vector)
		=> Position2D.FromMeters(vector.X * Units.Kilometer.ToBaseFactor, vector.Y * Units.Kilometer.ToBaseFactor);
	...
	public static Position2D Feet2D(this Vector2 vector)
		=> Position2D.FromMeters(vector.X * Units.Foot.ToBaseFactor, vector.Y * Units.Foot.ToBaseFactor);
	...
	public static Displacement2D KilometersDisplacement2D(this Vector2 vector)
		=> Displacement2D.FromMeters(vector.X * Units.Kilometer.ToBaseFactor, vector.Y * Units.Kilometer.ToBaseFactor);
	...
	public static Displacement2D FeetDisplacement2D(this Vector2 vector)
		=> Displacement2D.FromMeters(vector.X * Units.Foot.ToBaseFactor, vector.Y * Units.Foot.ToBaseFactor);
	...
	public static Velocity2D KilometersPerHour2D(this Vector2 vector)
		=> Velocity2D.FromMetersPerSecond(vector.X * Units.KilometersPerHour.ToBaseFactor, vector.Y * Units.KilometersPerHour.ToBaseFactor);
	...
	public static Velocity2D MilesPerHour2D(this Vector2 vector)
		=> Velocity2D.FromMetersPerSecond(vector.X * Units.MilesPerHour.ToBaseFactor, vector.Y * Units.MilesPerHour.ToBaseFactor);
	...
	public static Force2D PoundsForce2D(this Vector2 vector)
		=> Force2D.FromNewtons(vector.X * Units.PoundForce.ToBaseFactor, vector.Y * Units.PoundForce.ToBaseFactor);
	...
	public static Position3D Kilometers3D(this Vector3 vector)
		=> Position3D.FromMeters(vector.X * Units.Kilometer.ToBaseFactor, vector.Y * Units.Kilometer.ToBaseFactor, vector.Z * Units.Kilometer.ToBaseFactor);
	...
	public static Position3D Feet3D(this Vector3 vector)
		=> Position3D.FromMeters(vector.X * Units.Foot.ToBaseFactor, vector.Y * Units.Foot.ToBaseFactor, vector.Z * Units.Foot.ToBaseFactor);
	...
	public static Displacement3D KilometersDisplacement3D(this Vector3 vector)
		=> Displacement3D.FromMeters(vector.X * Units.Kilometer.ToBaseFactor, vector.Y * Units.Kilometer.ToBaseFactor, vector.Z * Units.Kilometer.ToBaseFactor);
	...
	public static Displacement3D FeetDisplacement3D(this Vector3 vector)
		=> Displacement3D.FromMeters(vector.X * Units.Foot.ToBaseFactor, vector.Y * Units.Foot.ToBaseFactor, vector.Z * Units.Foot.ToBaseFactor);
	...
	public static Velocity3D KilometersPerHour3D(this Vector3 vector)
		=> Velocity3D.FromMetersPerSecond(vector.X * Units.KilometersPerHour.ToBaseFactor, vector.Y * Units.KilometersPerHour.ToBaseFactor, vector.Z * Units.KilometersPerHour.ToBaseFactor);
	...
	public static Velocity3D MilesPerHour3D(this Vector3 vector)
		=> Velocity3D.FromMetersPerSecond(vector.X * Units.MilesPerHour.ToBaseFactor, vector.Y * Units.MilesPerHour.ToBaseFactor, vector.Z * Units.MilesPerHour.ToBaseFactor);
	...
	public static Force3D PoundsForce3D(this Vector3 vector)
		=> Force3D.FromNewtons(vector.X * Units.PoundForce.ToBaseFactor, vector.Y * Units.PoundForce.ToBaseFactor, vector.Z * Units.PoundForce.ToBaseFactor);
