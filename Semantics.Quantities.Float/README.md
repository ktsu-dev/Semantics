...
[![NuGet Version](https://img.shields.io/nuget/v/ktsu.Semantics.Quantities.Float?label=Stable&logo=nuget)](https://nuget.org/packages/ktsu.Semantics.Quantities.Float)
[![NuGet Version](https://img.shields.io/nuget/vpre/ktsu.Semantics.Quantities.Float?label=Latest&logo=nuget)](https://nuget.org/packages/ktsu.Semantics.Quantities.Float)
[![NuGet Downloads](https://img.shields.io/nuget/dt/ktsu.Semantics.Quantities.Float?label=Downloads&logo=nuget)](https://nuget.org/packages/ktsu.Semantics.Quantities.Float)
...
`ktsu.Semantics.Quantities.Float` is a satellite of [`ktsu.Semantics.Quantities`](../Semantics.Quantities/README.md) in the [ktsu.Semantics](../README.md) family. Read the core package README first for the quantity API itself.
