...
/// </summary>
public sealed record SoundTransmissionClass : Generic.SoundTransmissionClass<double>
{
	/// <summary>
	...
	public static new SoundTransmissionClass FromRating(double rating) => new() { Quantity = rating };
}
