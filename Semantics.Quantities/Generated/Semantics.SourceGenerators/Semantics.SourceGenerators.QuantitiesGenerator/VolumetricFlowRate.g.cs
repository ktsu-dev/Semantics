...
public partial record VolumetricFlowRate<T> : PhysicalQuantity<VolumetricFlowRate<T>, T>, IVector0<VolumetricFlowRate<T>, T>
	where T : struct, INumber<T>
{
	...
	public override DimensionInfo Dimension => PhysicalDimensions.VolumetricFlowRate;
