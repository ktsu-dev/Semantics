...
public readonly partial record struct ClockSpeed<T> : IVector0<ClockSpeed<T>, T>, IPhysicalQuantity<ClockSpeed<T>, T>
	where T : struct, INumber<T>
{
	...
	public static ClockSpeed<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<ClockSpeed<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<ClockSpeed<T>, T>(this, other);

	/// <summary>Adds two <see cref="ClockSpeed{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ClockSpeed<T> operator +(ClockSpeed<T> left, ClockSpeed<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="ClockSpeed{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ClockSpeed<T> operator -(ClockSpeed<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="ClockSpeed{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ClockSpeed<T> operator *(ClockSpeed<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="ClockSpeed{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ClockSpeed<T> operator *(T left, ClockSpeed<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="ClockSpeed{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ClockSpeed<T> operator /(ClockSpeed<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="ClockSpeed{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(ClockSpeed<T> left, ClockSpeed<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(ClockSpeed<T> left, ClockSpeed<T> right) => left.Quantity < right.Quantity;
	...
	/// <returns>A new ClockSpeed instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static ClockSpeed<T> FromKilohertz(T value) => Create(Vector0Guards.EnsureNonNegative((value * MetricMagnitudes.Values<T>.Kilo), nameof(value)));
	...
	/// <returns>A new ClockSpeed instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static ClockSpeed<T> FromMegahertz(T value) => Create(Vector0Guards.EnsureNonNegative((value * MetricMagnitudes.Values<T>.Mega), nameof(value)));
