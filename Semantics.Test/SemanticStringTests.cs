...
public class StringTests
{
	...
	private static readonly string[] expected = ["hello", "world", "test"];
	private static readonly string[] expectedArray = ["a", "b,c,d"];
	...
	{
		MySemanticString semanticString1 = SemanticString<MySemanticString>.FromString<MySemanticString>("test");
		MySemanticString semanticString2 = SemanticString<MySemanticString>.FromString<MySemanticString>("test");
		MySemanticString semanticString3 = SemanticString<MySemanticString>.FromString<MySemanticString>("apple");
	...
	{
		MySemanticString semanticString = SemanticString<MySemanticString>.FromString<MySemanticString>("hello world");
	...
	{
		MySemanticString semanticString = SemanticString<MySemanticString>.FromString<MySemanticString>("hello");
	...
	{
		MySemanticString semanticString1 = SemanticString<MySemanticString>.FromString<MySemanticString>("apple");
		MySemanticString semanticString2 = SemanticString<MySemanticString>.FromString<MySemanticString>("banana");
		MySemanticString semanticString3 = SemanticString<MySemanticString>.FromString<MySemanticString>("apple");
	...
	public void FromString_NullInput_ThrowsArgumentNullException()
	{
		Assert.ThrowsException<ArgumentNullException>(() =>
			SemanticString<MySemanticString>.FromString<MySemanticString>(null));
	}
	...
	{
		Assert.ThrowsException<ArgumentNullException>(() =>
			SemanticString<MySemanticString>.FromCharArray<MySemanticString>(null));
	}
	...
	public void FromReadOnlySpan_EmptySpan_CreatesEmptySemanticString()
	{
		...
		MySemanticString result = SemanticString<MySemanticString>.FromReadOnlySpan<MySemanticString>(emptySpan);
	...
	{
		MySemanticString original = SemanticString<MySemanticString>.FromString<MySemanticString>("test");
	...
	{
		MySemanticString semanticString = SemanticString<MySemanticString>.FromString<MySemanticString>("hello,world;test");
	...
	{
		MySemanticString semanticString = SemanticString<MySemanticString>.FromString<MySemanticString>("a,b,c,d");
	...
	{
		MySemanticString semanticString = SemanticString<MySemanticString>.FromString<MySemanticString>("xxhello worldxx");
	...
	{
		MySemanticString semanticString = SemanticString<MySemanticString>.FromString<MySemanticString>("Hello World Hello");
	...
	{
		MySemanticString semanticString = SemanticString<MySemanticString>.FromString<MySemanticString>("hello");
		Assert.ThrowsException<ArgumentNullException>(() => semanticString.IndexOfAny(null!));
	}
	...
	{
		MySemanticString semanticString = SemanticString<MySemanticString>.FromString<MySemanticString>("hello");
		Assert.ThrowsException<ArgumentNullException>(() => semanticString.LastIndexOfAny(null!));
	}

	[TestMethod]
	public void GetHashCode_ConsistentForSameContent()
	{
		MySemanticString semanticString1 = SemanticString<MySemanticString>.FromString<MySemanticString>("hello");
		MySemanticString semanticString2 = SemanticString<MySemanticString>.FromString<MySemanticString>("hello");
