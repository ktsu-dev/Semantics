...
public readonly partial record struct ElectricField1D<T> : IVector1<ElectricField1D<T>, T>, IPhysicalQuantity<ElectricField1D<T>, T>
	where T : struct, INumber<T>
{
	...
	public static ElectricField1D<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<ElectricField1D<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<ElectricField1D<T>, T>(this, other);

	/// <summary>Adds two <see cref="ElectricField1D{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ElectricField1D<T> operator +(ElectricField1D<T> left, ElectricField1D<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Subtracts one <see cref="ElectricField1D{T}"/> from another.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ElectricField1D<T> operator -(ElectricField1D<T> left, ElectricField1D<T> right) => Create(left.Quantity - right.Quantity);

	/// <summary>Negates a <see cref="ElectricField1D{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ElectricField1D<T> operator -(ElectricField1D<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="ElectricField1D{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ElectricField1D<T> operator *(ElectricField1D<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="ElectricField1D{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ElectricField1D<T> operator *(T left, ElectricField1D<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="ElectricField1D{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ElectricField1D<T> operator /(ElectricField1D<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="ElectricField1D{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(ElectricField1D<T> left, ElectricField1D<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(ElectricField1D<T> left, ElectricField1D<T> right) => left.Quantity < right.Quantity;
	...
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Voltage<T> operator *(ElectricField1D<T> left, Length<T> right) => Voltage<T>.Create(left.Quantity * right.Quantity);
}
