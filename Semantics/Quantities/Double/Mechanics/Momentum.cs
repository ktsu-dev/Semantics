...
public sealed record Momentum
{
	...
	public Generic.Momentum<double> Value { get; init; } = new();
	...
	public static Momentum FromKilogramMetersPerSecond(double kilogramMetersPerSecond) => new() { Value = Generic.Momentum<double>.FromKilogramMetersPerSecond(kilogramMetersPerSecond) };
