	...
	where T : struct, INumber<T>
{
	...
	/// <summary>
	/// Creates a new WindSpeed from a value in KilometerPerSecond.
	/// </summary>
	/// <param name="value">The value in KilometerPerSecond.</param>
	/// <returns>A new WindSpeed instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static WindSpeed<T> FromKilometerPerSecond(T value) => Create(Vector0Guards.EnsureNonNegative((value * MetricMagnitudes.Values<T>.Kilo), nameof(value)));
	...
	/// <returns>A new WindSpeed instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static WindSpeed<T> FromKilometerPerHour(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.KilometerPerHourToMeterPerSecond), nameof(value)));
	...
	/// <returns>A new WindSpeed instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static WindSpeed<T> FromMilePerHour(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.MilePerHourToMeterPerSecond), nameof(value)));
	...
	/// <returns>A new WindSpeed instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static WindSpeed<T> FromFootPerSecond(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.FootPerSecondToMeterPerSecond), nameof(value)));
	...
	/// <returns>A new WindSpeed instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static WindSpeed<T> FromKnot(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.KnotToMeterPerSecond), nameof(value)));
