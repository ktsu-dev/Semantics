...
/// </summary>
public sealed record Force2D : Generic.Force2D<double>
{
	...
	public static Force2D Create(Vector2d value) => new() { Value = value };
	...
	public static Force2D operator *(Force2D force, double scalar)
	{
	...
	public static Force2D operator *(double scalar, Force2D force)
	{
		ArgumentNullException.ThrowIfNull(force);
