...
public readonly partial record struct SoundAbsorption<T> : IVector0<SoundAbsorption<T>, T>, IPhysicalQuantity<SoundAbsorption<T>, T>
	where T : struct, INumber<T>
{
	...
	public static SoundAbsorption<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<SoundAbsorption<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<SoundAbsorption<T>, T>(this, other);

	/// <summary>Adds two <see cref="SoundAbsorption{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundAbsorption<T> operator +(SoundAbsorption<T> left, SoundAbsorption<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="SoundAbsorption{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundAbsorption<T> operator -(SoundAbsorption<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="SoundAbsorption{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundAbsorption<T> operator *(SoundAbsorption<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="SoundAbsorption{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundAbsorption<T> operator *(T left, SoundAbsorption<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="SoundAbsorption{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundAbsorption<T> operator /(SoundAbsorption<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="SoundAbsorption{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(SoundAbsorption<T> left, SoundAbsorption<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(SoundAbsorption<T> left, SoundAbsorption<T> right) => left.Quantity < right.Quantity;
	...
	/// <returns>A new SoundAbsorption instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SoundAbsorption<T> FromRadian(T value) => Create(Vector0Guards.EnsureNonNegative(value, nameof(value)));
	...
	/// <returns>A new SoundAbsorption instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SoundAbsorption<T> FromDegree(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.DegreeToRadians), nameof(value)));
	...
	/// <returns>A new SoundAbsorption instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SoundAbsorption<T> FromGradian(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.GradianToRadians), nameof(value)));
	...
	/// <returns>A new SoundAbsorption instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SoundAbsorption<T> FromRevolution(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.RevolutionToRadians), nameof(value)));
	...
	/// <returns>A new SoundAbsorption instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SoundAbsorption<T> FromMilliradian(T value) => Create(Vector0Guards.EnsureNonNegative((value * MetricMagnitudes.Values<T>.Milli), nameof(value)));

	/// <summary>
	/// Creates a new SoundAbsorption from a value in Percent.
	/// </summary>
	/// <param name="value">The value in Percent.</param>
	/// <returns>A new SoundAbsorption instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SoundAbsorption<T> FromPercent(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.PercentToRatio), nameof(value)));

	/// <summary>
	/// Creates a new SoundAbsorption from a value in PartPerMillion.
	/// </summary>
	/// <param name="value">The value in PartPerMillion.</param>
	/// <returns>A new SoundAbsorption instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SoundAbsorption<T> FromPartPerMillion(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.PartPerMillionToRatio), nameof(value)));

	/// <summary>
	/// Creates a new SoundAbsorption from a value in PartPerBillion.
	/// </summary>
	/// <param name="value">The value in PartPerBillion.</param>
	/// <returns>A new SoundAbsorption instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SoundAbsorption<T> FromPartPerBillion(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.PartPerBillionToRatio), nameof(value)));
	...
	/// <returns>A new SoundAbsorption instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static SoundAbsorption<T> FromPercentByWeight(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.PercentByWeightToRatio), nameof(value)));
	...
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundAbsorption<T> operator -(SoundAbsorption<T> left, SoundAbsorption<T> right) => Create(T.Abs(left.Quantity - right.Quantity));
}
