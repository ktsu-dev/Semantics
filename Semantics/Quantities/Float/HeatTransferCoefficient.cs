...
public sealed record HeatTransferCoefficient
{
	...
	public static new HeatTransferCoefficient FromWattsPerSquareMeterKelvin(float wattsPerSquareMeterKelvin) => new() { Value = Generic.HeatTransferCoefficient<float>.FromWattsPerSquareMeterKelvin(wattsPerSquareMeterKelvin) };
