...
public readonly partial record struct SpecificGravity<T> : IVector0<SpecificGravity<T>, T>, IPhysicalQuantity<SpecificGravity<T>, T>
	where T : struct, INumber<T>
{
	...
	public static SpecificGravity<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<SpecificGravity<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<SpecificGravity<T>, T>(this, other);

	/// <summary>Adds two <see cref="SpecificGravity{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SpecificGravity<T> operator +(SpecificGravity<T> left, SpecificGravity<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="SpecificGravity{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SpecificGravity<T> operator -(SpecificGravity<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="SpecificGravity{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SpecificGravity<T> operator *(SpecificGravity<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="SpecificGravity{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SpecificGravity<T> operator *(T left, SpecificGravity<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="SpecificGravity{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SpecificGravity<T> operator /(SpecificGravity<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="SpecificGravity{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(SpecificGravity<T> left, SpecificGravity<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(SpecificGravity<T> left, SpecificGravity<T> right) => left.Quantity < right.Quantity;
	...
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SpecificGravity<T> operator -(SpecificGravity<T> left, SpecificGravity<T> right) => Create(T.Abs(left.Quantity - right.Quantity));
}
