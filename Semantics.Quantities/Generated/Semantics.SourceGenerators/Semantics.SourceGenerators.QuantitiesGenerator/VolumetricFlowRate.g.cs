...
public readonly partial record struct VolumetricFlowRate<T> : IVector0<VolumetricFlowRate<T>, T>, IPhysicalQuantity<VolumetricFlowRate<T>, T>
	where T : struct, INumber<T>
{
	...
	public static VolumetricFlowRate<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<VolumetricFlowRate<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<VolumetricFlowRate<T>, T>(this, other);

	/// <summary>Adds two <see cref="VolumetricFlowRate{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static VolumetricFlowRate<T> operator +(VolumetricFlowRate<T> left, VolumetricFlowRate<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="VolumetricFlowRate{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static VolumetricFlowRate<T> operator -(VolumetricFlowRate<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="VolumetricFlowRate{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static VolumetricFlowRate<T> operator *(VolumetricFlowRate<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="VolumetricFlowRate{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static VolumetricFlowRate<T> operator *(T left, VolumetricFlowRate<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="VolumetricFlowRate{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static VolumetricFlowRate<T> operator /(VolumetricFlowRate<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="VolumetricFlowRate{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(VolumetricFlowRate<T> left, VolumetricFlowRate<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(VolumetricFlowRate<T> left, VolumetricFlowRate<T> right) => left.Quantity < right.Quantity;
	...
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Volume<T> operator *(VolumetricFlowRate<T> left, Duration<T> right) => Volume<T>.Create(left.Quantity * right.Quantity);
}
