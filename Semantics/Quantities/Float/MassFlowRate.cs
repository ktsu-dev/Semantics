...
public sealed record MassFlowRate
{
	...
	public static new MassFlowRate FromKilogramsPerSecond(float kilogramsPerSecond) => new() { Value = Generic.MassFlowRate<float>.FromKilogramsPerSecond(kilogramsPerSecond) };
