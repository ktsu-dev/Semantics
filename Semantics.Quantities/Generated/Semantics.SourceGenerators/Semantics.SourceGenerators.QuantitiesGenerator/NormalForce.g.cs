...
public readonly partial record struct NormalForce<T> : IVector0<NormalForce<T>, T>, IPhysicalQuantity<NormalForce<T>, T>
	where T : struct, INumber<T>
{
	...
	public static NormalForce<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<NormalForce<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<NormalForce<T>, T>(this, other);

	/// <summary>Adds two <see cref="NormalForce{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static NormalForce<T> operator +(NormalForce<T> left, NormalForce<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="NormalForce{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static NormalForce<T> operator -(NormalForce<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="NormalForce{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static NormalForce<T> operator *(NormalForce<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="NormalForce{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static NormalForce<T> operator *(T left, NormalForce<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="NormalForce{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static NormalForce<T> operator /(NormalForce<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="NormalForce{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(NormalForce<T> left, NormalForce<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(NormalForce<T> left, NormalForce<T> right) => left.Quantity < right.Quantity;
	...
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static NormalForce<T> operator -(NormalForce<T> left, NormalForce<T> right) => Create(T.Abs(left.Quantity - right.Quantity));
}
