...
public readonly partial record struct Sensitivity<T> : IVector0<Sensitivity<T>, T>, IPhysicalQuantity<Sensitivity<T>, T>
	where T : struct, INumber<T>
{
	...
	public static Sensitivity<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<Sensitivity<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<Sensitivity<T>, T>(this, other);

	/// <summary>Adds two <see cref="Sensitivity{T}"/> values.</summary>
	...
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(Sensitivity<T> left, Sensitivity<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(Sensitivity<T> left, Sensitivity<T> right) => left.Quantity < right.Quantity;
