...
public readonly partial record struct GroupVelocity<T> : IVector0<GroupVelocity<T>, T>, IPhysicalQuantity<GroupVelocity<T>, T>
	where T : struct, INumber<T>
{
	...
	public static GroupVelocity<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<GroupVelocity<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<GroupVelocity<T>, T>(this, other);

	/// <summary>Adds two <see cref="GroupVelocity{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static GroupVelocity<T> operator +(GroupVelocity<T> left, GroupVelocity<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="GroupVelocity{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static GroupVelocity<T> operator -(GroupVelocity<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="GroupVelocity{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static GroupVelocity<T> operator *(GroupVelocity<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="GroupVelocity{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static GroupVelocity<T> operator *(T left, GroupVelocity<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="GroupVelocity{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static GroupVelocity<T> operator /(GroupVelocity<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="GroupVelocity{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(GroupVelocity<T> left, GroupVelocity<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(GroupVelocity<T> left, GroupVelocity<T> right) => left.Quantity < right.Quantity;
	...
	/// <returns>A new GroupVelocity instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static GroupVelocity<T> FromKilometerPerHour(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.KilometerPerHourToMeterPerSecond), nameof(value)));
	...
	/// <returns>A new GroupVelocity instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static GroupVelocity<T> FromMilePerHour(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.MilePerHourToMeterPerSecond), nameof(value)));
	...
	/// <returns>A new GroupVelocity instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static GroupVelocity<T> FromFootPerSecond(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.FootPerSecondToMeterPerSecond), nameof(value)));
	...
	/// <returns>A new GroupVelocity instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static GroupVelocity<T> FromKnot(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.KnotToMeterPerSecond), nameof(value)));
	...
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static GroupVelocity<T> operator -(GroupVelocity<T> left, GroupVelocity<T> right) => Create(T.Abs(left.Quantity - right.Quantity));
}
