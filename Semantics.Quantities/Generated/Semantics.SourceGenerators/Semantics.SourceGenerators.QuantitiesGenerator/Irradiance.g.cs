...
public readonly partial record struct Irradiance<T> : IVector0<Irradiance<T>, T>, IPhysicalQuantity<Irradiance<T>, T>
	where T : struct, INumber<T>
{
	...
	public static Irradiance<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<Irradiance<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<Irradiance<T>, T>(this, other);

	/// <summary>Adds two <see cref="Irradiance{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Irradiance<T> operator +(Irradiance<T> left, Irradiance<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="Irradiance{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Irradiance<T> operator -(Irradiance<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="Irradiance{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Irradiance<T> operator *(Irradiance<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="Irradiance{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Irradiance<T> operator *(T left, Irradiance<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="Irradiance{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Irradiance<T> operator /(Irradiance<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="Irradiance{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(Irradiance<T> left, Irradiance<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(Irradiance<T> left, Irradiance<T> right) => left.Quantity < right.Quantity;
	...
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Irradiance<T> operator -(Irradiance<T> left, Irradiance<T> right) => Create(T.Abs(left.Quantity - right.Quantity));

	/// <summary>
	/// Multiplies Irradiance by Area to produce Power.
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Power<T> operator *(Irradiance<T> left, Area<T> right) => Power<T>.Create(left.Quantity * right.Quantity);
}
