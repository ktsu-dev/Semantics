...
public readonly partial record struct ReverberationTime<T> : IVector0<ReverberationTime<T>, T>, IPhysicalQuantity<ReverberationTime<T>, T>
	where T : struct, INumber<T>
{
	...
	public static ReverberationTime<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<ReverberationTime<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<ReverberationTime<T>, T>(this, other);

	/// <summary>Adds two <see cref="ReverberationTime{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ReverberationTime<T> operator +(ReverberationTime<T> left, ReverberationTime<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="ReverberationTime{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ReverberationTime<T> operator -(ReverberationTime<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="ReverberationTime{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ReverberationTime<T> operator *(ReverberationTime<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="ReverberationTime{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ReverberationTime<T> operator *(T left, ReverberationTime<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="ReverberationTime{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ReverberationTime<T> operator /(ReverberationTime<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="ReverberationTime{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(ReverberationTime<T> left, ReverberationTime<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(ReverberationTime<T> left, ReverberationTime<T> right) => left.Quantity < right.Quantity;
	...
	/// <returns>A new ReverberationTime instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static ReverberationTime<T> FromMillisecond(T value) => Create(Vector0Guards.EnsureNonNegative((value * MetricMagnitudes.Values<T>.Milli), nameof(value)));
	...
	/// <returns>A new ReverberationTime instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static ReverberationTime<T> FromMicrosecond(T value) => Create(Vector0Guards.EnsureNonNegative((value * MetricMagnitudes.Values<T>.Micro), nameof(value)));
	...
	/// <returns>A new ReverberationTime instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static ReverberationTime<T> FromMinute(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.MinuteToSeconds), nameof(value)));
	...
	/// <returns>A new ReverberationTime instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static ReverberationTime<T> FromHour(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.HourToSeconds), nameof(value)));
	...
	/// <returns>A new ReverberationTime instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static ReverberationTime<T> FromDay(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.DayToSeconds), nameof(value)));
	...
	/// <returns>A new ReverberationTime instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static ReverberationTime<T> FromYear(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.YearToSeconds), nameof(value)));
	...
	/// <returns>A new ReverberationTime instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static ReverberationTime<T> FromWeek(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.WeekToSeconds), nameof(value)));
	...
	/// <returns>A new ReverberationTime instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static ReverberationTime<T> FromNanosecond(T value) => Create(Vector0Guards.EnsureNonNegative((value * MetricMagnitudes.Values<T>.Nano), nameof(value)));
	...
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ReverberationTime<T> operator -(ReverberationTime<T> left, ReverberationTime<T> right) => Create(T.Abs(left.Quantity - right.Quantity));
}
