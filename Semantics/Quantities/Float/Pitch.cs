...
public sealed record Pitch
{
	...
	public static new Pitch FromHertz(float hertz) => new() { Value = Generic.Pitch<float>.FromHertz(hertz) };
	...
	/// <returns>A new Pitch instance.</returns>
	public static new Pitch FromMels(float mels) => new() { Value = Generic.Pitch<float>.FromMels(mels) };
	...
	/// <returns>A new Pitch instance.</returns>
	public static new Pitch FromBarks(float barks) => new() { Value = Generic.Pitch<float>.FromBarks(barks) };
