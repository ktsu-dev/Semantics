...
public readonly partial record struct ElectricPowerDensity<T> : IVector0<ElectricPowerDensity<T>, T>, IPhysicalQuantity<ElectricPowerDensity<T>, T>
	where T : struct, INumber<T>
{
	...
	public static ElectricPowerDensity<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<ElectricPowerDensity<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<ElectricPowerDensity<T>, T>(this, other);

	/// <summary>Adds two <see cref="ElectricPowerDensity{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ElectricPowerDensity<T> operator +(ElectricPowerDensity<T> left, ElectricPowerDensity<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="ElectricPowerDensity{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ElectricPowerDensity<T> operator -(ElectricPowerDensity<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="ElectricPowerDensity{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ElectricPowerDensity<T> operator *(ElectricPowerDensity<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="ElectricPowerDensity{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ElectricPowerDensity<T> operator *(T left, ElectricPowerDensity<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="ElectricPowerDensity{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static ElectricPowerDensity<T> operator /(ElectricPowerDensity<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="ElectricPowerDensity{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(ElectricPowerDensity<T> left, ElectricPowerDensity<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(ElectricPowerDensity<T> left, ElectricPowerDensity<T> right) => left.Quantity < right.Quantity;
	...
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static Power<T> operator *(ElectricPowerDensity<T> left, Volume<T> right) => Power<T>.Create(left.Quantity * right.Quantity);
}
