...
public readonly partial record struct AngularJerkMagnitude<T> : IVector0<AngularJerkMagnitude<T>, T>, IPhysicalQuantity<AngularJerkMagnitude<T>, T>
	where T : struct, INumber<T>
{
	...
	public static AngularJerkMagnitude<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<AngularJerkMagnitude<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<AngularJerkMagnitude<T>, T>(this, other);

	/// <summary>Adds two <see cref="AngularJerkMagnitude{T}"/> values.</summary>
	...
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(AngularJerkMagnitude<T> left, AngularJerkMagnitude<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(AngularJerkMagnitude<T> left, AngularJerkMagnitude<T> right) => left.Quantity < right.Quantity;
	...
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static AngularJerkMagnitude<T> operator -(AngularJerkMagnitude<T> left, AngularJerkMagnitude<T> right) => Create(T.Abs(left.Quantity - right.Quantity));

	/// <summary>
	/// Multiplies AngularJerkMagnitude by Duration to produce AngularAccelerationMagnitude.
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static AngularAccelerationMagnitude<T> operator *(AngularJerkMagnitude<T> left, Duration<T> right) => AngularAccelerationMagnitude<T>.Create(left.Quantity * right.Quantity);
}
