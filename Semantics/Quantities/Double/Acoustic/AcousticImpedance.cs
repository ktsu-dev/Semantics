...
public sealed record AcousticImpedance : Generic.AcousticImpedance<double>
{
	...
	public static new AcousticImpedance FromPascalSecondsPerMeter(double pascalSecondsPerMeter) => new() { Quantity = pascalSecondsPerMeter };
	...
	/// <returns>A new AcousticImpedance instance.</returns>
	public static new AcousticImpedance FromRayls(double rayls) => new() { Quantity = rayls };
}
