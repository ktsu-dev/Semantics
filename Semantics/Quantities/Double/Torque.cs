...
public sealed record Torque
{
	...
	public Generic.Torque<double> Value { get; init; } = new();
	...
	public static Torque FromNewtonMeters(double newtonMeters) => new() { Value = Generic.Torque<double>.FromNewtonMeters(newtonMeters) };
