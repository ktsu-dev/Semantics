	...
	where T : struct, INumber<T>
{
	...
	/// <returns>A new HalfLife instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static HalfLife<T> FromMillisecond(T value) => Create(Vector0Guards.EnsurePositive((value * MetricMagnitudes.Values<T>.Milli), nameof(value)));
	...
	/// <returns>A new HalfLife instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static HalfLife<T> FromMicrosecond(T value) => Create(Vector0Guards.EnsurePositive((value * MetricMagnitudes.Values<T>.Micro), nameof(value)));
	...
	/// <returns>A new HalfLife instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static HalfLife<T> FromMinute(T value) => Create(Vector0Guards.EnsurePositive((value * Units.ConversionConstants.Values<T>.MinuteToSeconds), nameof(value)));
	...
	/// <returns>A new HalfLife instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static HalfLife<T> FromHour(T value) => Create(Vector0Guards.EnsurePositive((value * Units.ConversionConstants.Values<T>.HourToSeconds), nameof(value)));
	...
	/// <returns>A new HalfLife instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static HalfLife<T> FromDay(T value) => Create(Vector0Guards.EnsurePositive((value * Units.ConversionConstants.Values<T>.DayToSeconds), nameof(value)));
	...
	/// <returns>A new HalfLife instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static HalfLife<T> FromYear(T value) => Create(Vector0Guards.EnsurePositive((value * Units.ConversionConstants.Values<T>.YearToSeconds), nameof(value)));
	...
	/// <returns>A new HalfLife instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static HalfLife<T> FromWeek(T value) => Create(Vector0Guards.EnsurePositive((value * Units.ConversionConstants.Values<T>.WeekToSeconds), nameof(value)));
	...
	/// <returns>A new HalfLife instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static HalfLife<T> FromNanosecond(T value) => Create(Vector0Guards.EnsurePositive((value * MetricMagnitudes.Values<T>.Nano), nameof(value)));
