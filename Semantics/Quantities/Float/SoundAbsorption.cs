...
public sealed record SoundAbsorption
{
	...
	public Generic.SoundAbsorption<float> Value { get; init; } = new();
	...
	public static new SoundAbsorption FromCoefficient(float coefficient) => new() { Value = Generic.SoundAbsorption<float>.FromCoefficient(coefficient) };
	...
	/// <returns>A new SoundAbsorption instance.</returns>
	public static new SoundAbsorption FromPercentage(float percentage) => new() { Value = Generic.SoundAbsorption<float>.FromPercentage(percentage) };
