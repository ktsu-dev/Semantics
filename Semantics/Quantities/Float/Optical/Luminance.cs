...
public sealed record Luminance
{
	...
	public static Luminance FromCandelaPerSquareMeter(float candelaPerSquareMeter) => new() { Value = Generic.Luminance<float>.FromCandelaPerSquareMeter(candelaPerSquareMeter) };
