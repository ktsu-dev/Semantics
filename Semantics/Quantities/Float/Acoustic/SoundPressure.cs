...
public sealed record SoundPressure
{
	...
	public static SoundPressure FromPascals(float pascals) => new() { Value = Generic.SoundPressure<float>.FromPascals(pascals) };
	...
	/// <returns>A new SoundPressure instance.</returns>
	public static SoundPressure FromMicropascals(float micropascals) => new() { Value = Generic.SoundPressure<float>.FromMicropascals(micropascals) };
	...
	/// <returns>A new SoundPressure instance.</returns>
	public static SoundPressure FromBars(float bars) => new() { Value = Generic.SoundPressure<float>.FromBars(bars) };
