...
public sealed record ReverberationTime : Generic.ReverberationTime<float>
{
	...
	public static new ReverberationTime FromSeconds(float seconds) => new() { Value = seconds };
	...
	/// <returns>A new ReverberationTime instance.</returns>
	public static new ReverberationTime FromT60(float t60) => new() { Value = t60 };
	...
	/// <returns>A new ReverberationTime instance.</returns>
	public static new ReverberationTime FromT30(float t30) => new() { Value = t30 };
}
