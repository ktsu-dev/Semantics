...
public sealed record Sensitivity : Generic.Sensitivity<double>
{
	...
	public static new Sensitivity FromDbSplPerWatt(double dbSplPerWatt) => new() { Value = dbSplPerWatt };
	...
	/// <returns>A new Sensitivity instance.</returns>
	public static new Sensitivity FromDbSplPerVolt(double dbSplPerVolt) => new() { Value = dbSplPerVolt };
	...
	/// <returns>A new Sensitivity instance.</returns>
	public static new Sensitivity FromMvPerPa(double mvPerPa) => new() { Value = mvPerPa };
}
