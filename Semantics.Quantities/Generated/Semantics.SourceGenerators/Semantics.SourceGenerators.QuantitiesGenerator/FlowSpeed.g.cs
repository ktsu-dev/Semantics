	...
	where T : struct, INumber<T>
{
	...
	/// <returns>A new FlowSpeed instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static FlowSpeed<T> FromKilometerPerHour(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.KilometerPerHourToMeterPerSecond), nameof(value)));
	...
	/// <returns>A new FlowSpeed instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static FlowSpeed<T> FromMilePerHour(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.MilePerHourToMeterPerSecond), nameof(value)));
	...
	/// <returns>A new FlowSpeed instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static FlowSpeed<T> FromFootPerSecond(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.FootPerSecondToMeterPerSecond), nameof(value)));
	...
	/// <returns>A new FlowSpeed instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static FlowSpeed<T> FromKnot(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.KnotToMeterPerSecond), nameof(value)));
