...
public sealed record SoundPower
{
	...
	public static SoundPower FromWatts(float watts) => new() { Value = Generic.SoundPower<float>.FromWatts(watts) };
	...
	/// <returns>A new SoundPower instance.</returns>
	public static SoundPower FromMilliwatts(float milliwatts) => new() { Value = Generic.SoundPower<float>.FromMilliwatts(milliwatts) };
	...
	/// <returns>A new SoundPower instance.</returns>
	public static SoundPower FromAcousticWatts(float acousticWatts) => new() { Value = Generic.SoundPower<float>.FromAcousticWatts(acousticWatts) };
