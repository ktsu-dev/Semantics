...
public sealed record Wavelength : Generic.Wavelength<double>
{
	...
	public static new Wavelength FromMeters(double meters) => new() { Value = meters };
	...
	/// <returns>A new Wavelength instance.</returns>
	public static new Wavelength FromMillimeters(double millimeters) => new() { Value = millimeters };
	...
	/// <returns>A new Wavelength instance.</returns>
	public static new Wavelength FromMicrometers(double micrometers) => new() { Value = micrometers };
}
