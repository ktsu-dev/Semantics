...
public sealed record Acceleration2D : Generic.Acceleration2D<double>
{
	...
	/// <returns>A new instance of the quantity.</returns>
	public static Acceleration2D Create(double x, double y) => Create(new Vector2d(x, y));
	...
	public static Acceleration2D FromMetersPerSecondSquared(double x, double y) => Create(x, y);
	...
	/// <returns>A new Acceleration2D instance.</returns>
	public static Acceleration2D FromMetersPerSecondSquared(Vector2 metersPerSecondSquared) => Create(new Vector2d(metersPerSecondSquared.X, metersPerSecondSquared.Y));
