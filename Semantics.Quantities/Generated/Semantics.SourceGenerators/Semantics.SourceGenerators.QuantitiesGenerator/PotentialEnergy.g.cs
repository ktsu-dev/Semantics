	...
	where T : struct, INumber<T>
{
	...
	/// <returns>A new PotentialEnergy instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static PotentialEnergy<T> FromKilojoule(T value) => Create(Vector0Guards.EnsureNonNegative((value * MetricMagnitudes.Values<T>.Kilo), nameof(value)));
	...
	/// <returns>A new PotentialEnergy instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static PotentialEnergy<T> FromElectronVolt(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.ElectronVoltToJoules), nameof(value)));
	...
	/// <returns>A new PotentialEnergy instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static PotentialEnergy<T> FromCalorie(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.CalorieToJoules), nameof(value)));
	...
	/// <returns>A new PotentialEnergy instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static PotentialEnergy<T> FromKilocalorie(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.KilocalorieToJoules), nameof(value)));
	...
	/// <returns>A new PotentialEnergy instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static PotentialEnergy<T> FromKilowattHour(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.KilowattHourToJoules), nameof(value)));
	...
	/// <returns>A new PotentialEnergy instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static PotentialEnergy<T> FromWattHour(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.WattHourToJoules), nameof(value)));
	...
	/// <returns>A new PotentialEnergy instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static PotentialEnergy<T> FromErg(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.ErgToJoules), nameof(value)));
	...
	/// <returns>A new PotentialEnergy instance.</returns>
	/// <exception cref="System.ArgumentException">Thrown when the resulting magnitude would be negative.</exception>
	public static PotentialEnergy<T> FromBtu(T value) => Create(Vector0Guards.EnsureNonNegative((value * Units.ConversionConstants.Values<T>.BtuToJoules), nameof(value)));
