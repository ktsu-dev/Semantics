...
public partial record Inductance<T> : PhysicalQuantity<Inductance<T>, T>, IVector0<Inductance<T>, T>
	where T : struct, INumber<T>
{
	...
	public override DimensionInfo Dimension => PhysicalDimensions.Inductance;
