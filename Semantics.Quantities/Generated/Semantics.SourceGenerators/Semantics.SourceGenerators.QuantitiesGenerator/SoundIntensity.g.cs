...
public readonly partial record struct SoundIntensity<T> : IVector0<SoundIntensity<T>, T>, IPhysicalQuantity<SoundIntensity<T>, T>
	where T : struct, INumber<T>
{
	...
	public static SoundIntensity<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<SoundIntensity<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<SoundIntensity<T>, T>(this, other);

	/// <summary>Adds two <see cref="SoundIntensity{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundIntensity<T> operator +(SoundIntensity<T> left, SoundIntensity<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="SoundIntensity{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundIntensity<T> operator -(SoundIntensity<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="SoundIntensity{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundIntensity<T> operator *(SoundIntensity<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="SoundIntensity{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundIntensity<T> operator *(T left, SoundIntensity<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="SoundIntensity{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static SoundIntensity<T> operator /(SoundIntensity<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="SoundIntensity{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(SoundIntensity<T> left, SoundIntensity<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(SoundIntensity<T> left, SoundIntensity<T> right) => left.Quantity < right.Quantity;
