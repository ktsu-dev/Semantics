...
public sealed record Wavelength
{
	...
	public static new Wavelength FromMeters(float meters) => new() { Value = Generic.Wavelength<float>.FromMeters(meters) };
	...
	/// <returns>A new Wavelength instance.</returns>
	public static new Wavelength FromMillimeters(float millimeters) => new() { Value = Generic.Wavelength<float>.FromMillimeters(millimeters) };
	...
	/// <returns>A new Wavelength instance.</returns>
	public static new Wavelength FromMicrometers(float micrometers) => new() { Value = Generic.Wavelength<float>.FromMicrometers(micrometers) };
