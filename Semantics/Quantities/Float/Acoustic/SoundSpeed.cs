...
public sealed record SoundSpeed
{
	...
	public static SoundSpeed FromMetersPerSecond(float metersPerSecond) => new() { Value = Generic.SoundSpeed<float>.FromMetersPerSecond(metersPerSecond) };
	...
	/// <returns>A new SoundSpeed instance.</returns>
	public static SoundSpeed FromFeetPerSecond(float feetPerSecond) => new() { Value = Generic.SoundSpeed<float>.FromFeetPerSecond(feetPerSecond) };
