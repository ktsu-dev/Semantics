...
public readonly partial record struct EnergyFluxDensity<T> : IVector0<EnergyFluxDensity<T>, T>, IPhysicalQuantity<EnergyFluxDensity<T>, T>
	where T : struct, INumber<T>
{
	...
	public static EnergyFluxDensity<T> Create(T value) => new() { Quantity = value };
	...
	public int CompareTo(IPhysicalQuantity<T> other) => PhysicalQuantityCore.Compare<EnergyFluxDensity<T>, T>(this, other);
	...
	public bool Equals(IPhysicalQuantity<T> other) => PhysicalQuantityCore.AreEqual<EnergyFluxDensity<T>, T>(this, other);

	/// <summary>Adds two <see cref="EnergyFluxDensity{T}"/> values.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static EnergyFluxDensity<T> operator +(EnergyFluxDensity<T> left, EnergyFluxDensity<T> right) => Create(left.Quantity + right.Quantity);

	/// <summary>Negates a <see cref="EnergyFluxDensity{T}"/>.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static EnergyFluxDensity<T> operator -(EnergyFluxDensity<T> value) => Create(-value.Quantity);

	/// <summary>Scales a <see cref="EnergyFluxDensity{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static EnergyFluxDensity<T> operator *(EnergyFluxDensity<T> left, T right) => Create(left.Quantity * right);

	/// <summary>Scales a <see cref="EnergyFluxDensity{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static EnergyFluxDensity<T> operator *(T left, EnergyFluxDensity<T> right) => Create(left * right.Quantity);

	/// <summary>Divides a <see cref="EnergyFluxDensity{T}"/> by a bare number.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static EnergyFluxDensity<T> operator /(EnergyFluxDensity<T> left, T right) => T.IsZero(right) ? throw new System.DivideByZeroException("Cannot divide by zero.") : Create(left.Quantity / right);

	/// <summary>Divides one <see cref="EnergyFluxDensity{T}"/> by another, giving the bare ratio.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static T operator /(EnergyFluxDensity<T> left, EnergyFluxDensity<T> right) => T.IsZero(right.Quantity) ? throw new System.DivideByZeroException("Cannot divide by zero.") : left.Quantity / right.Quantity;

	/// <summary>Reports whether the left value sorts before the right.</summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static bool operator <(EnergyFluxDensity<T> left, EnergyFluxDensity<T> right) => left.Quantity < right.Quantity;
	...
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "CA2225:Operator overloads have named alternates", Justification = "Physics quantity operator")]
	public static EnergyFluxDensity<T> operator -(EnergyFluxDensity<T> left, EnergyFluxDensity<T> right) => Create(T.Abs(left.Quantity - right.Quantity));
}
